    ...
    <div class="container">
        ...
        <div class="properties-grid" style="margin-top: var(--spacing-lg);">
            ...
            <?php
                ...
                $placeholders = [
                    ['Seaside Serenity Villa',  '$1,250,000', '4', '3', 'Villa',     'Malibu, California',  'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=600&q=80', 'Coastal Escapes — Where Waves Beckon'],
                    ['Metropolitan Haven',      '$650,000',   '2', '2', 'Apartment', 'Manhattan, New York', 'https://images.unsplash.com/photo-1486325212027-8081e485255e?w=600&q=80', 'Urban Oasis — Life in the Heart of the City'],
                    ['Rustic Retreat Cottage',  '$350,000',   '3', '2', 'Cottage',   'Aspen, Colorado',     'https://images.unsplash.com/photo-1518780664697-55e3ad937233?w=600&q=80', 'Countryside Charm — Escape to Nature\'s Embrace'],
                ];
                foreach ($placeholders as $p) : ?>
                <div class="property-card">
                    <div class="property-card__image" style="position:relative">
                        <img src="<?php echo $p[6]; ?>" alt="<?php echo $p[0]; ?>" style="width:100%;height:100%;object-fit:cover;">
                        <div class="property-card__location-badge">
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
                            <?php echo $p[5]; ?>
                        </div>
                    ...
                    <div class="property-card__body">
                        ...
                        <p class="property-card__desc">A stunning property offering breathtaking views and world-class amenities. <a href="#" style="color:var(--color-accent)">Read More</a></p>
                        <div class="property-card__specs">
