...
<section class="section service-block" id="unlock">
    <div class="container">
        ...
        <div class="service-block__grid">
            ...
            $sell_services = [
                ...
                ['icon'=>'✅', 'title'=>'Closing Success',      'desc'=>'A successful sale is not complete until the closing. We guide you through the intricate closing process.'],
            ];
            ...
            <div class="service-cta-card card">
                ...
                <a href="<?php echo get_permalink(get_page_by_path('contact')); ?>" class="btn btn-outline btn-sm">Learn More</a>
            </div>
        </div>
    </div>
</section>
...
<section class="section service-block" id="management">
    <div class="container">
        ...
        <div class="service-block__grid">
            ...
            $mgmt_services = [
                ...
                ['icon'=>'⚖️', 'title'=>'Legal Guardian',        'desc'=>'Stay compliant with property laws and regulations effortlessly.'],
            ];
...
<!-- SMART INVESTMENTS -->
<section class="section service-block" id="investments">
    <div class="container">
        <div class="service-block__investments">
            <div class="service-block__investments-left">
                ...
                <div class="service-cta-card card" style="margin-top: var(--spacing-md)">
                    ...
                    <a href="<?php echo get_permalink(get_page_by_path('contact')); ?>" class="btn btn-outline btn-sm" style="margin-top:12px">Learn More</a>
                </div>
            </div>
